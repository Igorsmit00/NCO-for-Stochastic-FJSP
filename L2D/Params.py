...
# Stochastic
parser.add_argument('--SAA_attention', type=str2bool, default=False, help='Flag of whether use SAA attention')
parser.add_argument('--SAA_dim', type=int, default=16, help='Hidden dim of SAA')
